  ...
  return (
    <div className="text-center space-y-8">
      ...
      <div className="flex justify-center gap-4">
        <button className="bg-[#191919] rounded-full py-3 px-8 text-white font-jetbrains flex items-center gap-x-2 shadow-[0px_2px_4px_0px_#A158FF_inset,0px_-4px_12px_0px_rgba(190,_166,_255,_0.50)]">
          <span>Open Dapp</span>
        ...
        <button className="bg-transparent border-white border rounded-full py-3 px-12 text-white font-jetbrains ">
          <span>Read doc</span>
        </button>
      </div>
    </div>
